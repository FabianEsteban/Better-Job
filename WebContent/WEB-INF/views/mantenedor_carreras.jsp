...
<link href="../resources/static/css/mantenedor_carreras.css" rel="stylesheet">
	...
	<section id="main-content">
		<section class="wrapper" >
			<div id="regForm">
					...
					<table id="Table_carrera" class="table-responsive table table-striped table-bordered" cellspacing="0" width="100%"></table>
				</div>
